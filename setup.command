...
if [[ "$OSTYPE" == "darwin"* && -x "$(command -v sips)" ]]; then
  ...
  sips --resampleHeight 960 $SCRIPT_PATH/photos/**/*.min.jpeg &>/dev/null
  sips --resampleHeight 960 $SCRIPT_PATH/photos/**/*.min.png &>/dev/null
  sips --resampleHeight 960 $SCRIPT_PATH/photos/**/*.min.jpg &>/dev/null
